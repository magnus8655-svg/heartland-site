            ...
            <Card className="brutalist-card p-12 bg-card text-card-foreground text-center">
              ...
              <div className="space-y-4 mb-8 text-left">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
  <Check className="h-6 w-6 text-accent mt-1 flex-shrink-0" />
  <span className="text-lg">Free hosting included</span>
</div>
                </div>
                <div className="flex items-start gap-3">
                  <Check className="h-6 w-6 text-accent mt-1 flex-shrink-0" />
              ...
              <div className="border-t-2 border-border pt-6">
               ...
               <p className="text-lg">Free hosting included. Small fee only if you request future updates.</p>
              </div>
  ...
  contacts@heartlandservicegroup.com
            ...
            <div className="text-right">
              <p className="text-sm text-muted-foreground">
                © 2026 Heartland Service Group. All rights reserved.
              </p>
            </div>
          </div>
        </div>
